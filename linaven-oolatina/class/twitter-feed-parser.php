...
$access_token			= '2468034763-taL639AqE4mfG3DkUHhytHpQZyWYj3oY6w7FvBO';
$access_token_secret		= 'MCxMKokJYydgq5hns5EjkQIMDBh3XmDjGIxltG9tucsi8';
$consumer_key			= 'mLJt3ln8QPz3ywD6lUYlb44vU';
$consumer_secret		= 'bsOl64HI2vplZRI0lvVQUjBQ4vt4uo7V0GB0KsoEZ7nH9abpTR';

// Some variables
$twitter_username 		= 'fabricerubino';
		...
		if (isset($twitter_stream[0]->text)) {
			...
			foreach ($twitter_stream as $tweet){
				...
				if ($tweet_start_char != '@' || $ignore_replies == false) {
					...
					$tweets .= '<dl class="dl-horizontal f-twitter"><dt><i class="fa fa-twitter"></i></dt><dd><a href="https://twitter.com/'.$twitter_username.'" target="newpage">@'.$twitter_username.' </a> '.$tweet_text.' <span>'.ago($tweet->created_at,$tweet->id,$tweet->user->screen_name).'</span></dd></dl>'."\n";
