			...
			<div class="col-md-12 sale-product">
				...
				<div class="def-block">
						<?php
							...
							$arrayId[1]['id'] = "dance-shows";
							$arrayId[1]['number'] = "10";
							$arrayId[2]['title'] = "Dance Workshops";
							$arrayId[2]['id'] = "dance-workshops";
							$arrayId[2]['number'] = "45";
							$arrayId[3]['title'] = "Dance Party";
							$arrayId[3]['id'] = "dance-party";
							$arrayId[3]['number'] = "46";
							$arrayId[4]['title'] = "Salsa Cubaine";
							$arrayId[4]['id'] = "salsa-cubaine";
							$arrayId[4]['number'] = "22";
							$arrayId[5]['title'] = "Salsa Portoricaine";
							$arrayId[5]['id'] = "salsa-portoricaine";
							$arrayId[5]['number'] = "47";
							...
							/*<div style="width:100%;height:35px;">
								  <div class="input-group" style="float:right;width:430px;height:30px;">
									<input placeholder="Search video" id="searchvideo" class="form-control" type="text" style="float:left;width:350px;height:30px;" name="search">
									<input type="button" onclick="searchVideo();" value="" style="float:left;width:59px;height:30px;background-color:#4486F7;border-width:0px;border-radius:10px;-moz-border-radius:10px;background-image:url('images/search_icon.png');background-repeat:no-repeat;background-position:center;">
								  </div>
							</div>*/
							?>
